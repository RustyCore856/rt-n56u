...
#define DEF_WLAN_2G_SSID	BOARD_PID "OpenWrt_2G"
#define DEF_WLAN_5G_SSID	BOARD_PID "OpenWrt_2G"
#define DEF_WLAN_2G_GSSID	BOARD_PID "OpenWrt_GUEST_%s"
#define DEF_WLAN_5G_GSSID	BOARD_PID "OpenWrt_GUEST_5G_%s"
